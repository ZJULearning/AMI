...
from onmt.trainer_nmt_conv import build_trainer
...
def main(opt, device_id, batch_queue=None, semaphore=None):
    ...
    a_speaker_id = vocab['src'].fields[0][1].vocab.stoi['<a>']
    b_speaker_id = vocab['src'].fields[0][1].vocab.stoi['<b>']
    logger.info('=' * 40)
    logger.info('pad_id:{}, bos_id:{}, eos_id: {}, a_speaker_id: {}, b_speaker_id: {}'.format(
        pad_id, bos_id, eos_id, a_speaker_id, b_speaker_id))
    logger.info('=' * 40)
